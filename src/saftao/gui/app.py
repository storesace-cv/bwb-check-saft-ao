...
VALIDATOR_SCRIPT = TOOLS_ROOT / "validator_saft_ao.py"
AUTOFIX_SOFT_SCRIPT = TOOLS_ROOT / "saft_ao_autofix_soft.py"
AUTOFIX_HARD_SCRIPT = TOOLS_ROOT / "saft_ao_autofix_hard.py"
...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Resolve SAF-T (AO)")
